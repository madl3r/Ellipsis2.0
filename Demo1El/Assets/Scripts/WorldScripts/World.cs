...
//		Debug.Log("Getting the players for this level");
	...
	public void finishRound()
	{
		...
		countDownObj.GetComponent<CountDownScript>().nums[timeLeftBtwnRound].GetComponent<Renderer>().enabled = true;
		bossCountDownObj.GetComponent<CountDownScript>().nums[timeLeftBtwnRound].GetComponent<Renderer>().enabled = true;
		...
		if (round >= roundsToFirstUpgrade)
		{
			...
			upgradeArrow.GetComponent<Renderer>().enabled = true;
			foreach (GameObject line in lines)
			{
		...
		{
			preBossArrow.GetComponent<Renderer>().enabled = true;
			bossSkull.GetComponent<Renderer>().enabled = true;
		...
		if (round >= roundsToShopArea)
		{
			...
			shopArrow.GetComponent<Renderer>().enabled = true;
	...
	void newRound()
	{
		...
		upgradeArrow.GetComponent<Renderer>().enabled = false;
		preBossArrow.GetComponent<Renderer>().enabled = false;
		bossSkull.GetComponent<Renderer>().enabled = false;
		shopArrow.GetComponent<Renderer>().enabled = false;
	...
	public void decrementRoundCount()
	{
		...
		countDownObj.GetComponent<CountDownScript>().nums[timeLeftBtwnRound].GetComponent<Renderer>().enabled = false;
		bossCountDownObj.GetComponent<CountDownScript>().nums[timeLeftBtwnRound].GetComponent<Renderer>().enabled = false;
		//decrement
		timeLeftBtwnRound--;
	...
	void setCounterInvisible()
	{
		...
		{
			number.GetComponent<Renderer>().enabled = false;
		}
	...
	public void gameOver()
	{
		...
		GameObject.Find("GameOverScreen").GetComponent<Renderer>().enabled = true;
